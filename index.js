...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:pg123@localhost:5432/';
const config = {
...
app.get('/', waiterRoutes.getLogingScreen);
app.post('', waiterRoutes.logingTheUser);
